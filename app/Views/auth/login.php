    ...
    <div class="container">
        ...
        <div class="row d-flex login justify-content-center mt-5">
            ...
            <div class="container pt-4">
                <?php if (session()->getFlashdata('berhasilDaftar')) : ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <?= session()->getFlashdata('berhasilDaftar'); ?>
            ...
            <div class="col-6 right-side">
                <h1 class="fw-bold">Komik</h1>
                <h5 class="text-secondary">Masukan Username dan Password akunmu pada form dibawah, jika belum membuat akun dapat mendaftar terlebih dahulu.</h5>
                ...
                <div class="login-form mt-4-5">
                    <form action="/postlogin" method="POST">
                        ...
                        <div class="mb-3">
                            <a href="/register"><small>Belum punya akun?</small></a>
                        </div>
